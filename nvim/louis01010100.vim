...
let s:nord2_gui = "#363D4C"
let s:nord3_gui = "#4C566B"
let s:nord3_gui_bright = "#4C566B"
"let s:nord4_gui = "#ADB1BA"
"nord4_gui has factor = 0.7
let s:nord4_gui = "#979BA3" 
...
"   call s:hi("VertSplit", s:nord2_gui, "NONE", s:nord3_term, s:nord1_term, "NONE", "")
" endif
call s:hi("VertSplit", s:nord2_gui, "NONE", s:nord3_term, s:nord1_term, "NONE", "")
